            ...
            <div id="content">
                <c:if test="${!empty userForm.user}">
				    ...
				    <table class="myTable">
					    <tr>
						    <td>
							    <label for="name"><spring:message code="openclassroom.username" text="User Name:" /></label>
						...
						<tr>
							<td>
							    <label for="password"><spring:message code="openclassroom.password" text="Password:" /></label>
								<label class="mandatory">*</label>
							</td>
							<td>
						...
						<tr>
							<td>
								<label for="name"><spring:message code="openclassroom.role" text="Role:" /></label>
								<label class="mandatory">*</label>
							</td>
							<td>

...
public interface UserService {
     ...
     */
    UserVO logIn(final UserVO user) throws UserException;
     ...
     * @throws UserException on error
     */
    void addNewUser(final UserVO user) throws UserException;
     ...
     * @throws UserException on error
     */
    UserVO getUserDetailsFromID(final Long id) throws UserException;
     ...
     * @throws UserException on error
     */
    void updateUser(final UserVO user) throws UserException;
     ...
     * @throws UserException on error
     */
    List<UserVO> searchUserDetails(final UserVO searchUser) throws UserException;
}
